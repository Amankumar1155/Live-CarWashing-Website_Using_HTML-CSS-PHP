    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="index.html"><img src="../../assets/images/dmc.png"
                        alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="index.html"><img src="../../assets/images/adp.png "
                        alt="logo" /></a>
            </div>
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="container-fluid d-flex justify-content-between">
                        <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">Copyright © Rabia
                            group of industries 2022</span>
                        <span class="float-none float-sm-end mt-1 mt-sm-0 text-end"> Designed and developed by <a
                                href="https://www.fastesterbsolution.com" target="_blank">Fastest Web
                                Solution</a></span>
                    </div>
                </footer>
                <!-- partial -->
